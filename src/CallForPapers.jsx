  ...
  <section className="relative w-full mt-20 h-[220px] overflow-hidden rounded-2xl">
      ...
      <div className="max-w-5xl mx-auto px-6 text-slate-700">
        <p className="mb-6 text-lg">
          ...
          Engineering, Communication and Computing Technology. Specifically, it
          covers (but not limited to) the following tracks:
        </p>

        <ol className="list-decimal list-inside space-y-2 text-base font-medium">
          <li>Renewable Energy Systems and Sustainable Energy Technologies</li>
          <li>
        ...
        <ol className="list-decimal list-inside space-y-3 text-base">
          <li>
            Authors are required to submit their manuscripts using Microsoft CMT
          ...
          <li>
            ...
            found to not meet the plagiarism policy may be desk-rejected without
            further review.
          </li>
          <li>
          ...
          <li>
            XXXCUTMXX-2026 strictly prohibits authors from altering their details
            or the sequence of authors once a manuscript has been submitted.
          </li>
        </ol>
        <h2 className="mt-12 mb-4 text-3xl font-extrabold text-slate-900">
          Publication:

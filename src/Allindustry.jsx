          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 text-left space-y-6">
            <div className="flex items-start gap-4">
              ...
              <p className="text-lg leading-relaxed text-gray-800">
                From all accepted submissions,{" "}
                <strong>
                  one outstanding paper authored entirely by industry-affiliated
                  contributors
                </strong>{" "}
                will be selected for the{" "}
                <strong>All-Industry Authored Paper Award</strong>.
              </p>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <p className="text-lg leading-relaxed text-gray-800">
                ...
                <strong>all authors are affiliated with industry</strong>,
                highlighting real-world problem-solving and applied research
                excellence.
              </p>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <p className="text-lg leading-relaxed text-gray-800">
                ...
                <strong>quality and originality of the work</strong>, the{" "}
                <strong>effectiveness of the presentation</strong>, and the{" "}
                <strong>
                  level of engagement during the question-and-answer session
                </strong>
                .
              </p>
            </div>

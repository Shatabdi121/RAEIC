  ...
  <section className="max-w-6xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-10 items-center">
    ...
    <div data-aos="fade-left">
      ...
      <p className="text-lg leading-relaxed">
        ...
        multi-sector, private state university committed to delivering
        transformative education through skill-integrated and
        practice-oriented learning. The university emphasizes innovation,
  ...
  <section className="max-w-6xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-10 items-center">
    ...
    <div data-aos="fade-right" className="order-2 md:order-1">
      ...
      <p className="text-lg leading-relaxed">
        ...
        holistic education and sustainable development. Its mission focuses
        on inclusive education, research excellence, innovation, and
        empowering communities through technology and governance.
      </p>
    </div>

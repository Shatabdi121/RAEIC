...
const Home = () => {
  ...
  const places = [
    {
      ...
      image: lingaraj,
      history:
        "An 11th-century temple dedicated to Lord Shiva, a masterpiece of Kalinga architecture.",
    },
    {
      name: "Puri Jagannath",
      distance: "57 KM",
    ...
    },
    {
      ...
      image: konark,
      history:
        "A 13th-century UNESCO World Heritage site shaped like a massive stone chariot.",
    },
    {
      ...
      image: Dhauli,
      history:
        "A Buddhist peace pagoda marking Emperor Ashoka’s transformation after the Kalinga war.",
    },
    {
      ...
      image: zoo,
      history:
        "A unique zoological park known for conservation and white tigers.",
    },
    {
      name: "Chilika Lake",
      distance: "112 KM",
      image: chilika,
      history:
        "Asia’s largest brackish water lagoon, home to migratory birds and dolphins.",
    },
    {
      ...
      distance: "55 KM",
      history:
        "Barabati Stadium, hosts cricket, football, and cultural events since 1958,",
    },
    {
      ...
      distance: "4 KM",
      history:
        "Stunning 11th-century temple built with red and yellow sandstone.",
    },
  ];
  ...
  return (
    <main className="relative w-full overflow-x-hidden">
      ...
      <div className="relative w-full h-screen overflow-hidden">
        ...
        <div className="absolute inset-0 z-10 pointer-events-none">
          <div
            ...
            style={{
              background:
                "linear-gradient(to right, #f3f5f0 0%, #f3f5f0 0%, rgba(243,245,240,0) 80%)",
            }}
          />
        </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="text-center mb-16" data-aos="fade-up">
            ...
            <p className="max-w-4xl mx-auto text-lg text-slate-700 leading-relaxed">
              The AI Enabled Smart Solutions for Industry, Governance,
              Healthcare, and Sustainable Development (AISIGH–SD) 2026
              conference, organized by Centurion University of Technology and
              Management in collaboration with the IEEE Bhubaneswar Section, is
              a platform for researchers and professionals to explore
              advancements in artificial intelligence across diverse domains.
              Covering areas such as machine learning, IoT, computer vision,
              healthcare, industry, governance, and sustainability, the
              conference promotes innovation, collaboration, and the development
              ...
              <ul className="space-y-4">
                ...
                >
                  ...
                  <span className="text-slate-700 text-lg md:text-base">
                    Provides an interdisciplinary platform to showcase
                    AI-enabled innovations addressing challenges in industry,
                    governance, healthcare, and sustainable development.
                  </span>
                </li>
                <li
                  data-aos="fade-up"
                ...
                >
                  ...
                  <span className="text-slate-700 text-lg md:text-base">
                    Focuses on advanced technologies including smart grids,
                    Industry 4.0, robotics, digital healthcare, and AI-driven
                ...
                >
                  ...
                  <span className="text-slate-700 text-lg md:text-base">
                    Encourages collaboration among researchers, industry
                    experts, and policymakers to enhance technical excellence,
                    real-world impact, and regional engagement.
                  </span>
                </li>
              </ul>
            </div>
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-8 transition-all duration-500">
                ...
                <p className="text-white text-lg leading-relaxed italic opacity-90 group-hover:opacity-100 transition-opacity duration-500">
                  Advancing AI-driven smart solutions for industry, governance,
                  healthcare, and sustainable development through innovation,
                  resilience, and regional collaboration
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-12 px-4">
            ...
            <p className="mt-3 text-gray-700 text-lg">
              Hosted at Centurion University, Bhubaneswar — explore the rich
      ...
      <section
        id="schedule"
        className="py-16 bg-[#E7ECFF] border-t border-blue-200 overflow-x-hidden"
      >
                  ...
                  <table class="w-full text-left border-collapse">
                    <thead>
                      <tr class="bg-transparent">
                        <th class="py-3 px-4 text-xl font-bold text-slate-800 border-r border-b border-gray-500">
                          Event
                        </th>
                        <th class="py-3 px-4 text-xl font-bold text-slate-800 border-b border-gray-500">
                          Date
                        </th>
                      </tr>
                    </thead>
                    ...
                    <td class="py-4 px-4 border-r border-b border-gray-500">
                      ...
                      <tr>
                        <td class="py-4 px-4 border-r border-gray-500">
                          Date of Conference
                        </td>
                        <td class="py-4 px-4">28/12/2026 - 30/12/2026</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
